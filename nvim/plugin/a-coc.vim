...
nmap <silent> <leader>atd <Plug>(coc-type-definition)
nmap <silent> <leader>ai <Plug>(coc-implementation)
nmap <silent> <leader>ar <Plug>(coc-references)
nmap <silent> <leader>arn <Plug>(coc-rename)
nmap <silent> <leader>arf <Plug>(coc-refactor)

nnoremap <leader>as :CocSearch <C-R>=expand("<cword>")<CR><CR>
...
nmap <leader>aca  <Plug>(coc-codeaction)
